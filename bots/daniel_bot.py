...
class BotPlayer(Player):
    ...
    def __init__(self, team: Team):
        ...
        self.et_pairs : list[RobotInfo] = []
        return

    def best_explore(self, explorer, game_state: GameState) -> None:
        # Dummy function
        x = 0
    ...
    def explore_action(self, game_state: GameState) -> None:
        ...
        for exp, ter in self.et_pairs:
            ...
            self.best_explore(exp, game_state)
            game_state.move_robot(ter, (old_exp_row - ter.row, old_exp_col - ter.col))
